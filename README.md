...
## How to Play
1. Click START GAME
2. Tap/click on cockroaches to smash them
3. Earn higher scores with quick combos
4. Watch out - they get faster over time!

## Installation
**Web Version:**  
Simply visit: [Play Now](https://meciefa.github.io/Camacho-finalact1-killthecockroaches/)

**PWA Installation:**  
1. Open in Chrome/Edge on desktop or mobile
2. Click the "📲 INSTALL APP" button
3. Enjoy fullscreen gameplay!
...
To run locally:
```bash
git clone https://github.com/meciefa/Camacho-finalact1-killthecockroaches.git
cd Camacho-finalact1-killthecockroach
# Open index.html in browser

Credits
Developed by [Camacho, Mecie Faith A.]
